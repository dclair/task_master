...
urlpatterns = [
    ...
    # Incluyo rutas de autenticación de Django (login, logout y password management).
    path("accounts/", include("django.contrib.auth.urls")),
    # Incluyo rutas de la app boards.
    path("boards/", include("boards.urls")),
    # Expongo paginas legales.
